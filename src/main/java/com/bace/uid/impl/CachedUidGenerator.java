package com.bace.uid.impl;

import com.bace.uid.BitsAllocator;
import com.bace.uid.UidGenerator;
import com.bace.uid.buffer.BufferPaddingExecutor;
import com.bace.uid.buffer.RejectedPutBufferHandler;
import com.bace.uid.buffer.RejectedTakeBufferHandler;
import com.bace.uid.buffer.RingBuffer;
import com.bace.uid.exception.UidGenerateException;
import com.bace.uid.worker.WorkerIdAssigner;
...
public class CachedUidGenerator extends DefaultUidGenerator {
    ...
    public CachedUidGenerator(WorkerIdAssigner workerIdAssigner, int timeBits, int workerBits, int seqBits,
                              int boostPower, Long scheduleInterval) {
        // initialize workerId & bitsAllocator
        super(workerIdAssigner, timeBits, workerBits, seqBits);

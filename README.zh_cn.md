...
### 步骤3: 修改Spring配置
提供了两种生成器: [DefaultUidGenerator](src/main/java/com/bace/uid/impl/DefaultUidGenerator.java)、[CachedUidGenerator](src/main/java/com/bace/uid/impl/CachedUidGenerator.java)。如对UID生成性能有要求, 请使用CachedUidGenerator<br/>
